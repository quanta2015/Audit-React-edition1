...
class listData extends React.Component {
  ...
  async componentDidMount() {
    ...
    // let n = r.data.filter(item=>{ return (item.exist==1)?item:null })
        ...
        <div className="m-detail">
          <div className="m-detail-wrap">
            ...
            <div className="m-form">
              ...
              <div className="m-tl">
                <span>中国知网指标(第一列著作指标 第二列著者指标)</span>
              ...
              <div className="m-tl">
                ...
                <div className="m-upload">
                  上传截图
                  <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'cssci')}/>
                </div>
              </div>
          ...
          <div className="m-detail-fun">
            ...
            {(record.status == 0) && <Button className="c-orange" onClick={this.doSubmitS1}>提交关键词审核</Button> }
