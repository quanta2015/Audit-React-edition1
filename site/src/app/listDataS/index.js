...
class listData extends React.Component {
  ...
  async componentDidMount() {
    ...
    let r = await this.props.userStore.getProjListS()
  ...
  doSubmitS1 = async () => {
    ...
    this.setState({ loading: true })
    let r = await this.props.userStore.subProject1(params)
  ...
  doSubmitS2 = async () => {
    ...
    this.setState({ loading: true })
    let r = await this.props.userStore.subProject3(params)
    this.setState({ loading: false, show: false,list: r.data  })
    message.success('提交成功！')
  }
  ...
  doUpload= async (type,e) => {
    ...
    let { list,show,record,showImg,showZ } = this.state
    ...
    const columns = [{
        ...
        render: (text, record, index) => (
          < >
            {(record.exist == 1)&&(record.status != 0) && (record.status != 2) && <Button type="default" icon="file" onClick={this.doEdit.bind(this,record)}>详情</Button> }
            {(record.exist == 1)&&(record.status == 0) && <Button type="primary" icon="edit" onClick={this.doEdit.bind(this,record)}>开始编辑</Button> }
            {(record.exist == 1)&&(record.status == 2) && <Button className="c-orange" type="primary" icon="edit" onClick={this.doEdit.bind(this,record)}>开始编辑</Button> }
          </>
        ),
      },
    ];
      ...
      <div className="g-list">
        ...
        <div className="m-detail">
          <div className="m-detail-wrap">
            ...
            <div className="m-r">
              ...
              <div className="m-form">
                ...
                <div className="m-tl">
                  <span>中国知网指标(第一列著作指标 第二列作者指标)</span>
                  ...
                  <div className="m-upload">
                    上传截图
                    <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'zhi1')}/>
                  </div>
                  ...
                  <div className="m-upload">
                    上传截图
                    <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'zhi2')}/>
                  </div>
                </div>
                ...
                <div className="m-tl">
                  ...
                  <div className="m-upload">
                    上传截图
                    <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'cssci1')}/>
                  </div>
                  ...
                  <div className="m-upload">
                    上传截图
                    <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'cssci2')}/>
                  </div>
                </div>
                ...
                <div className="m-wrap">
                  <div className="m-tl">
                    ...
                    <div className="m-upload">
                      上传截图
                      <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'cao1')}/>
                    </div>
                    ...
                    <div className="m-upload">
                      上传截图
                      <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'cao2')}/>
                    </div>
                  </div>
                  <div className="m-row">
                    <div className="m-g">
                ...
                <div className="m-wrap">
                  <div className="m-tl">
                    ...
                    <div className="m-upload">
                      上传截图
                      <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'dou')}/>
                    </div>
                  </div>
                  <div className="m-row">
                    <div className="m-g">
                  ...
                  <div className="m-row">
                    <div className="m-g" style={{flex:1}}>
                ...
                <div className="m-tl">
                  ...
                  { (this.state.record.ws1_file) && 
                    ...
                    <div className="m-upload">
                      上传截图
                      <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'ws1')}/>
                    </div>
                  { (this.state.record.ws2_file) && 
                    ...
                    <div className="m-upload">
                      上传截图
                      <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'ws2')}/>
                    </div>
                  { (this.state.record.ws3_file) && 
                    ...
                    <div className="m-upload">
                      上传截图
                      <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'ws3')}/>
                    </div>
                </div>
                ...
                <div className="m-upload">
                  截图1
                  <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'trans1')} />
                </div>
                ...
                <div className="m-upload">
                  截图2
                  <input className="u-upload" type="file" accept="image/*" onChange={this.doUpload.bind(this,'trans2')}/>
                </div>
              </div>
          ...
          <div className="m-detail-fun">
            ...
            { ((record.status == 0)||(record.status == 2)) && <Button className="c-green" onClick={this.doSave}>保 存</Button> }
            {(record.status == 0) && <Button className="c-orange" onClick={this.doSubmitS1}>提交整体审核</Button> }
            {(record.status == 2) && <Button className="c-orange" onClick={this.doSubmitS2}>提交整体审核</Button> }
          </div>
        </div>}
